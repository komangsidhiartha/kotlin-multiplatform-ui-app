...
This is an exploratory project to learn and demonstrate how to share code between multiple platforms using Kotlin Multiplatform. The project is based on the template generated by the Kotlin Multiplatform wizard and currently focuses on sharing code between Android, iOS, and Desktop (JVM) applications.
...
*   **Shared Data Layer:** The `PostModel` and `PostRepository` are defined in the `shared` module and are used by the Android, iOS, and Desktop apps.
